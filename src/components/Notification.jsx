...
const Notification = ({ message, type = 'info', duration = 3000, onClose }) => {
  ...
  const getNotificationStyles = () => {
    const baseStyles = "w-full p-4 rounded-lg shadow-lg transform transition-all duration-300 ease-out";
  ...
  return (
    <div 
      className={`${getNotificationStyles()} ${isVisible ? 'translate-x-0 opacity-100' : 'translate-x-full opacity-0'}`}
