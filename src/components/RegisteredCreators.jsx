// src/components/RegisteredCreators.jsx
import React, { useState, useEffect } from 'react';
import { API_ENDPOINTS } from '../appConstants';

// RegisteredCreators Component
const RegisteredCreators = ({ creators, onSelectCreator, onRegisterClick, isDarkMode, isLoading }) => {
  ...
  return (
    <div
      className={`flex flex-col items-center p-8 transition-colors duration-300 ${
        isDarkMode ? 'bg-gray-900' : 'bg-gray-100'
      }`}
    >
      {/* Header */}
      <div className="w-full flex flex-col sm:flex-row justify-between items-center mb-8 max-w-lg">
        <h1 className={`text-4xl font-bold ${textColor} mb-4 sm:mb-0`}>Creators</h1>
        <button
            ...
            >
              <div className="relative">
                {creator.image_id ? (
                  ...
                  <div
                    className={`w-24 h-24 rounded-lg flex items-center justify-center ${accentColor}`}
                  >
